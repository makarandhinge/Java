...
public class FirstApplication {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            String empString2;
            empString2 = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(employees);
            System.out.println(empString2);
...
class Employees {
    ...
    public List<Employee> getEmployees() {
        System.out.println("Employees Get loaded...");
        return employees;
    }

    public void setEmployees(List<Employee> employees) {
        System.out.println("Employees Set loaded...");
